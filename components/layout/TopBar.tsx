      ...
      <div className="flex-1">
        <DropdownMenu>
          ...
          <DropdownMenuContent align="start">
            ...
            <DropdownMenuItem>Zen Biotech</DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem>New board approval request</DropdownMenuItem>
            <DropdownMenuItem>409A valuation due soon</DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
